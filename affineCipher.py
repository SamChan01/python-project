...
def checkKeys(keyA, keyB, mode):
    if keyA == 1 and mode == 'encrypt':
        sys.exit("Cipher is weak if key A is 1. Choose different key.")
    if keyB == 0 and mode == 'encrypt':
        sys.exit("Cipher is weak if key B is 0. Choose different key.")
...
# If affineCipher.py is run (instead of imported as a module), recall
# the main() function:
