...
def makeMove(board, chests, x, y):
    ...
    if smallestDistance == 0:
        # xy is directyly on a treasure chest!
        chests.remove([x, y])
...
def enterPlayerMove(previousMoves):
    ...
    while True:
        ...
        print("Enter a number from 0, 59, a space, then a number from 0 to 14.")
...
Press enter to continue...""")
    ...
    print("""When you drop a sonar device directly on a chest, you retrieve it and the other sonar devices update to show how far away the next nearest chest is. THe chests
...
while True:
    ...
    while sonarDevices > 0:
        ...
        print("You have %s sonar device(s) left, % streasure chest(s) remaining. " % (sonarDevices, len(theChests)))

        x, y = enterPlayerMove(previousMoves)
        previousMoves.append([x, y]) # we must track all moves so that sonar devices can be updataed.
    ...
    if sonarDevices == 0:
        ...
        print("The remaning chests were here:")
